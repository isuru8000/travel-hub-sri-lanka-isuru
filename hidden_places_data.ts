...
const RAW_HIDDEN_PLACES: Record<string, HiddenPlace[]> = {
  /*
  ...
  "sigiriya": [
    {
      ...
      image: "https://images.unsplash.com/photo-150208221f6e7-7518d844c9b9?q=80&w=400&auto=webp&fit=crop",
  ...
  "yala": [
    {
      ...
      image: "https://images.unsplash.com/photo-1590486803838-7fd859bc0607?q=80&w=400&auto=webp&fit=crop",
...
export const HIDDEN_PLACES: Record<string, HiddenPlace[]> = Object.entries(RAW_HIDDEN_PLACES).reduce((acc, [key, places]) => {
  acc[key] = places.map(place => ({
    ...place,
    image: getOptimizedImageUrl(place.image, 600)
  }));
  return acc;
}, {} as Record<string, HiddenPlace[]>);
