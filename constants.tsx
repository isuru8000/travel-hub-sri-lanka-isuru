...
export const UI_STRINGS: Translation = {
  ...
  exploreNode: { EN: "Explore Now", SI: "දැන් ගවේෂණය කරන්න" },
...
export const HERITAGE_MUSIC_DATA: HeritageMusic[] = [
  ...
  { id: 'm3', type: 'instrument', name: { EN: 'Dawula', SI: 'දවුල' }, description: { EN: 'A drum used in Sabaragamuwa dancing.', SI: 'සබරගමු නර්න සම්ප්‍රදායේ රිද්මයානුකූල හදගැස්මයි.' }, image: 'https://images.unsplash.com/photo-1519114056088-b877fe073a5e?auto=format&fit=crop&w=800&q=80', origin: { EN: 'Sabaragamuwa', SI: 'සබරගමුව' }, significance: { EN: 'Used in temple ceremonies.', SI: 'පන්සල් වල හේවිසි වාදනය සඳහා අත්‍යවශ්‍ය වේ.' } },
  ...
  { id: 'm5', type: 'instrument', name: { EN: 'Horaneva', SI: 'හොරණෑව' }, description: { EN: 'An instrument with a sharp sound.', SI: 'තියුණු හඬක් නිකුත් කරන පාරම්පරික පිඹින වාද්‍ය භාණ්ඩයකි.' }, image: 'https://images.unsplash.com/photo-1516280440614-6697288d5d38?auto=format&fit=crop&w=800&q=80', origin: { EN: 'Ritual Arts', SI: 'චාරිත්‍ර කලාව' }, significance: { EN: 'Adds music to temple drumming.', SI: 'පන්සල් වාදන වලට මිහිරි තනු එක් කරයි.' } },
