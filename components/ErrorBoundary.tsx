      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
          <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            {isFirestoreError && (
              <div className="text-left bg-gray-100 p-4 rounded-lg text-xs font-mono text-gray-800 overflow-auto mb-6">
                <p><strong>Operation:</strong> {firestoreDetails.operationType}</p>
                <p><strong>Path:</strong> {firestoreDetails.path}</p>
                <p><strong>User ID:</strong> {firestoreDetails.authInfo?.userId || 'Not logged in'}</p>
              </div>
            )}
