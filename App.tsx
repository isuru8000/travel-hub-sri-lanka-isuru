          ...
          <div className="relative">
            ...
            <div className="relative z-10">
              ...
              <motion.div 
                ...
                className="py-8 md:py-20 flex flex-col md:flex-row justify-center bg-[#050505] border-y border-white/5 gap-4 md:gap-8 px-6"
              >
                <button 
                  onClick={() => setView('map')}
                  className="group relative px-6 py-4 md:px-12 md:py-6 bg-white text-black rounded-full font-black text-[10px] md:text-xs uppercase tracking-[0.3em] md:tracking-[0.4em] flex items-center justify-center gap-4 md:gap-6 shadow-2xl hover:scale-105 active:scale-95 transition-all overflow-hidden w-full md:w-auto"
                >
                  ...
                  <MapIcon size={16} className="text-blue-600 group-hover:rotate-12 transition-transform md:w-5 md:h-5" />
                ...
                <button 
                  ...
                  className="group relative px-6 py-4 md:px-12 md:py-6 bg-white/5 text-white border border-white/10 rounded-full font-black text-[10px] md:text-xs uppercase tracking-[0.3em] md:tracking-[0.4em] flex items-center justify-center gap-4 md:gap-6 shadow-xl hover:scale-105 active:scale-95 transition-all overflow-hidden w-full md:w-auto"
                >
                  ...
                  <Compass size={18} className="text-[#F59E0B] group-hover:rotate-180 transition-transform duration-1000 md:w-5 md:h-5" />
              ...
              <motion.div 
                ...
                viewport={{ once: true, margin: "-100px" }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className="py-20 md:py-52 px-4 md:px-6 relative overflow-hidden bg-[#050505]"
              >
                <div className="max-w-7xl mx-auto">
                  <div className="relative rounded-[3rem] md:rounded-[6rem] bg-[#0a0a0a] overflow-hidden group/card shadow-[0_30px_100px_rgba(0,0,0,0.5)] md:shadow-[0_60px_150px_rgba(0,0,0,0.5)] border border-white/5">
                    
                    {/* Atmospheric Background Mesh */}
                    <div className="absolute inset-0 opacity-20 pointer-events-none z-0">
                       <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_80%_20%,rgba(245,158,11,0.15)_0%,transparent_50%)]" />
                    ...
                    <div className="relative z-10 p-6 sm:p-10 md:p-24 space-y-12 md:space-y-20">
                       ...
                       <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 md:gap-10 border-b border-white/5 pb-10 md:pb-16">
                          <div className="space-y-8 md:space-y-12">
                             <div className="inline-flex items-center gap-3 md:gap-5 px-6 py-2 md:px-8 md:py-3 rounded-full bg-white/5 border border-white/10 text-[#F59E0B] text-[9px] md:text-[11px] font-black uppercase tracking-[0.4em] md:tracking-[0.6em] backdrop-blur-xl">
                             ...
                             <div className="space-y-6 md:space-y-8">
                               <h2 className="text-4xl sm:text-5xl md:text-[8rem] font-heritage font-bold text-white leading-[0.9] md:leading-[0.85] tracking-tighter uppercase mb-2 md:mb-4">
                                  {language === 'EN' ? (
                                    <>Uncover Your <br/><span className="italic text-[#F59E0B]">Destiny.</span></>
                                  ) : (
                                    <>ඔබේ <span className="text-[#F59E0B] italic">දෛවය</span> <br/>සොයාගන්න.</>
                                  )}
                               </h2>
                               <p className="text-white/40 text-lg sm:text-xl md:text-2xl font-light italic leading-relaxed border-l-4 border-[#F59E0B]/30 pl-6 md:pl-8">
                                  {language === 'EN' 
                          ...
                          >
                            <div className="absolute inset-0 bg-gradient-to-r from-amber-600/10 to-orange-400/10 opacity-0 group-hover:opacity-100 transition-opacity" />
                            <Compass size={16} className="relative z-10 text-[#F59E0B] group-hover:rotate-180 transition-transform duration-1000 md:w-6 md:h-6" />
                       ...
                       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
                          ...
                          <div className="group/shard relative aspect-[3/4] rounded-[3.5rem] overflow-hidden border border-white/10 shadow-2xl transition-all duration-1000 hover:-translate-y-4 hover:border-[#F59E0B]/40">
                             ...
                             <div className="absolute top-8 left-8 p-3 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
                                <Target size={18} className="text-[#F59E0B] animate-pulse" />
                             </div>
                             <div className="absolute bottom-10 left-10 right-10 space-y-2">
                                <p className="text-[9px] font-black uppercase tracking-[0.4em] text-[#F59E0B]">Registry_Node_01</p>
                          ...
                          <div className="group/shard relative aspect-[3/4] rounded-[3.5rem] overflow-hidden border border-white/10 shadow-2xl transition-all duration-1000 hover:-translate-y-4 hover:border-blue-400/40">
                             ...
                             <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent" />
                             <div className="absolute top-8 left-8 p-3 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
                                <Wind size={18} className="text-blue-400 animate-pulse" />
                             </div>
                             <div className="absolute bottom-10 left-10 right-10 space-y-2">
                                <p className="text-[9px] font-black uppercase tracking-[0.4em] text-blue-400">Registry_Node_02</p>
                          ...
                          <div className="group/shard relative aspect-[3/4] rounded-[3.5rem] overflow-hidden border border-white/10 shadow-2xl transition-all duration-1000 hover:-translate-y-4 hover:border-cyan-400/40">
                             ...
                             <div className="absolute bottom-10 left-10 right-10 space-y-2">
                                <p className="text-[9px] font-black uppercase tracking-[0.4em] text-cyan-400">Registry_Node_03</p>
                          ...
                          {/* Shard 4: Wild Heart */}
                          <div className="group/shard relative aspect-[3/4] rounded-[3.5rem] overflow-hidden border border-white/10 shadow-2xl transition-all duration-1000 hover:-translate-y-4 hover:border-emerald-400/40">
                             ...
                             <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent" />
                             <div className="absolute top-8 left-8 p-3 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
                                <PawPrint size={18} className="text-emerald-400 animate-pulse" />
                             </div>
                             <div className="absolute bottom-10 left-10 right-10 space-y-2">
                                <p className="text-[9px] font-black uppercase tracking-[0.4em] text-emerald-400">Registry_Node_04</p>
