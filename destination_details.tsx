...
const BASE_DESTINATIONS: Destination[] = [
  ...
  },
  {
    ...
    shortStory: { EN: "The Sacred Tree - A living link to the Buddha.", SI: "ශ්‍රී මහා බෝධිය - බුදුරජාණන් වහන්සේගේ ජීවමාන සාක්ෂිය." },
  ...
  },
  {
    ...
    shortStory: {
      EN: "The Polonnaruwa Vatadage is one of the most beautiful buildings in ancient Sri Lanka. The Circular Shrine - A masterpiece of stone carving.",
      SI: "පැරණි ශ්‍රී ලංකාවේ ඇති ලස්සනම ගොඩනැගිලිවලින් එකක් වන වටදාගෙය. වටදාගෙය - ශිලා කැටයම් කලාවේ විශිෂ්ටතම නිර්මාණය."
    },
    tips: [
