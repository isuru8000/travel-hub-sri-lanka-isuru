...
export async function* streamLankaGuideResponse(
  ...
  try {
    ...
    const systemInstruction = `
      ...
      sigiriya, ruwanwelisaya, jaya-sri-maha-bodhi, vatadageya, thuparamaya, abhayagiriya, jetavanaramaya, gal-vihara, lankatilaka-vihara, galle-fort, dambulla, kandy-temple, mihintale, yapahuwa, ritigala, buduruwagala, unawatuna, mirissa, hikkaduwa, arugambay, bentota, nilaveli, pasikudah, yala, udawalawe, minneriya, wilpattu, kumana, bundala, sinharaja, horton, ella, adam'speak, knuckles, haputale, pidurangala, riverston, diyaluma, bambarakanda, ravanafalls, dunhinda, baker'sfalls, stclair's, devonfalls, bopathella, laxapana, aberdeen.
      You can also navigate to specific categories using these IDs: foods, music, arts-crafts, medicine, phrases, essentials, festivals, quiz.
